...
from ansible_collections.ansible.amazon.tests.unit.compat.mock import MagicMock, patch
from ansible_collections.ansible.amazon.tests.unit.modules.utils import AnsibleExitJson, AnsibleFailJson, ModuleTestCase, set_module_args

from ansible_collections.ansible.amazon.plugins.modules.s3_bucket_notification import AmazonBucket, Config
from ansible_collections.ansible.amazon.plugins.modules import s3_bucket_notification
try:
...
class TestModule(ModuleTestCase):
    ...
    @patch('ansible_collections.ansible.amazon.plugins.modules.s3_bucket_notification.AnsibleAWSModule.client')
