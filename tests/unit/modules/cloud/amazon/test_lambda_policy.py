...
from ansible_collections.ansible.amazon.tests.unit.modules.utils import set_module_args

if not HAS_BOTO3:
    pytestmark = pytest.mark.skip("test_api_gateway.py requires the `boto3` and `botocore` modules")

# these are here cause ... boto!
from ansible_collections.ansible.amazon.plugins.modules import lambda_policy
from ansible_collections.ansible.amazon.plugins.modules.lambda_policy import setup_module_object
try:
