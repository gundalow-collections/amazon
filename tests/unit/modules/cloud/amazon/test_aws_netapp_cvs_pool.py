...
from ansible_collections.ansible.amazon.plugins.modules.aws_netapp_cvs_pool \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.amazon.plugins.modules.aws_netapp_cvs_pool.NetAppAWSCVS.get_aws_netapp_cvs_pool')
    @patch('ansible_collections.netapp.netapp.plugins.module_utils.netapp.AwsCvsRestAPI.put')
