...
from ansible_collections.ansible.amazon.tests.unit.compat.mock import MagicMock, Mock, patch
...
_temp = __import__('ansible_collections.ansible.amazon.plugins.modules.lambda')
