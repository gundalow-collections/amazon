...
from ansible_collections.ansible.amazon.tests.unit.compat.mock import patch, Mock
from ansible.module_utils import basic
from ansible.module_utils._text import to_bytes
from requests import Response


from ansible_collections.netapp.netapp.plugins.module_utils.netapp import AwsCvsRestAPI
from ansible_collections.ansible.amazon.plugins.modules.aws_netapp_cvs_active_directory \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.amazon.plugins.modules.aws_netapp_cvs_active_directory.AwsCvsNetappActiveDir.get_activedirectoryId')
    @patch('ansible_collections.ansible.amazon.plugins.modules.aws_netapp_cvs_active_directory.AwsCvsNetappActiveDir.get_activedirectory')
    @patch('ansible_collections.netapp.netapp.plugins.module_utils.netapp.AwsCvsRestAPI.post')
