...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.amazon.plugins.modules.aws_netapp_cvs_snapshots.AwsCvsNetappSnapshot.getSnapshotId')
    @patch('ansible_collections.ansible.amazon.plugins.modules.aws_netapp_cvs_snapshots.AwsCvsNetappSnapshot.getfilesystemId')
