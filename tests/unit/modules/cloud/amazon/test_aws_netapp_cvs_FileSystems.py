...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.amazon.plugins.modules.aws_netapp_cvs_FileSystems.AwsCvsNetappFileSystem.get_filesystemId')
    @patch('ansible_collections.netapp.netapp.plugins.module_utils.netapp.AwsCvsRestAPI.get_state')
    ...
    @patch('ansible_collections.ansible.amazon.plugins.modules.aws_netapp_cvs_FileSystems.AwsCvsNetappFileSystem.get_filesystemId')
    @patch('ansible_collections.ansible.amazon.plugins.modules.aws_netapp_cvs_FileSystems.AwsCvsNetappFileSystem.get_filesystem')
    @patch('ansible_collections.netapp.netapp.plugins.module_utils.netapp.AwsCvsRestAPI.get_state')
    @patch('ansible_collections.netapp.netapp.plugins.module_utils.netapp.AwsCvsRestAPI.delete')
