...
from ansible_collections.ansible.amazon.tests.unit.mock.procenv import ModuleTestCase

from ansible_collections.ansible.amazon.tests.unit.compat.mock import patch, MagicMock
