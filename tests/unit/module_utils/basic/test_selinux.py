...
from ansible_collections.ansible.amazon.tests.unit.mock.procenv import ModuleTestCase, swap_stdin_and_argv

from ansible_collections.ansible.amazon.tests.unit.compat.mock import patch, MagicMock, mock_open, Mock
