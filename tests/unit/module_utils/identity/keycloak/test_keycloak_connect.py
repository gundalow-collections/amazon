...
from ansible_collections.ansible.keycloak.plugins.module_utils.identity.keycloak.keycloak import (
    get_token,
    KeycloakError,
)
...
def mock_good_connection(mocker):
    ...
    return mocker.patch(
        'ansible_collections.ansible.keycloak.plugins.module_utils.identity.keycloak.keycloak.open_url',
