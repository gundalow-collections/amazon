...
def test_set_vm_power_state_task_timeout(mocker, fake_ansible_module, XenAPI, xenserver, power_state, error_msg):
    ...
    mocker.patch('ansible_collections.ansible.misc.plugins.module_utils.xenserver.wait_for_task', return_value="timeout")
...
def test_set_vm_power_state_transition_async(mocker,
    ...
    mocker.patch('ansible_collections.ansible.misc.plugins.module_utils.xenserver.wait_for_task', return_value="")
