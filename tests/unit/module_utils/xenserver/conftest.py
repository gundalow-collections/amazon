...
def XenAPI():
    ...
    fake_xenapi = importlib.import_module('ansible_collections.ansible.amazon.tests.unit.module_utils.xenserver.FakeXenAPI')
...
def xenserver(XenAPI):
    ...
    from ansible_collections.ansible.misc.plugins.module_utils import xenserver
