...
from ansible_collections.ansible.network.plugins.module_utils.network.common.utils import to_list, sort_list
from ansible_collections.ansible.network.plugins.module_utils.network.common.utils import dict_diff, dict_merge
from ansible_collections.ansible.network.plugins.module_utils.network.common.utils import conditional, Template
