...
import pytest
from ansible_collections.ansible.amazon.tests.unit.compat import mock
from ansible_collections.ansible.amazon.tests.unit.compat.mock import call, patch
...
class TestBaseConfigurationResource(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.ansible.misc.plugins.modules.ftd_configuration.Connection')
