...
- This module was called C(iam_mfa_device_facts) before Ansible 2.9. The usage did
  not change.
...
- boto3
- botocore
short_description: List the MFA (Multi-Factor Authentication) devices registered for
  a user
version_added: '2.2'
'''
