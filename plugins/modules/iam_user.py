...
DOCUMENTATION = '''author: Josh Souza (@joshsouza)
description:
...
from ansible_collections.ansible.amazon.plugins.module_utils.ec2 import camel_dict_to_snake_dict, ec2_argument_spec, get_aws_connection_info, boto3_conn
