...
options:
  maximum_tasks:
    description: The maximum value to scale to in response to a scale out event. This
      parameter is required if you are creating a first new policy for the specified
      service.
    required: false
    version_added: '2.6'
  minimum_tasks:
    description: The minimum value to scale to in response to a scale in event. This
      parameter is required if you are creating a first new policy for the specified
      service.
    required: false
    version_added: '2.6'
  override_task_capacity:
    default: false
    description: Whether or not to override values of minimum and/or maximum tasks
      if it's already set.
    required: false
    type: bool
    version_added: '2.6'
...
from ansible_collections.ansible.amazon.plugins.module_utils.ec2 import _camel_to_snake, camel_dict_to_snake_dict, ec2_argument_spec
