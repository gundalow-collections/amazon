...
DOCUMENTATION = '''author: Robert Estelle (@erydo)
description:
...
options:
  ...
  tags:
    ...
    - resource_tags
    description:
    - A dict of tags to apply to the internet gateway. Any tags currently applied
      to the internet gateway and not present here will be removed.
    version_added: '2.4'
  vpc_id:
    description:
