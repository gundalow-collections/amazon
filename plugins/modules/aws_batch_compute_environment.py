...
options:
  bid_percentage:
    ...
    - The minimum percentage that a Spot Instance price must be when compared with
      ...
      example, if your bid percentage is 20%, then the Spot price must be below 20%
...
from ansible_collections.ansible.amazon.plugins.module_utils.aws.batch import AWSConnection
