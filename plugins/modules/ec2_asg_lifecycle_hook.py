...
DOCUMENTATION = '''author: Igor 'Tsigankov' Eyrich (@tsiganenok) <tsiganenok@gmail.com>
description:
...
options:
  ...
  notification_target_arn:
    ...
    - The ARN of the notification target that Auto Scaling will use to notify you
      ...
      can be either an SQS queue or an SNS topic. If you specify an empty string,
  ...
  state:
    ...
    default: present
    description:
    - Create or delete Lifecycle Hook. Present updates existing one or creates if
      not found.
    required: false
  transition:
    choices:
