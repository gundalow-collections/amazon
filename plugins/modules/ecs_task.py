...
options:
  ...
  network_configuration:
    ...
    - I(network_configuration) has two keys, I(subnets), a list of subnet IDs to which
      the task is attached and I(security_groups), a list of group names or group
      IDs for the task
    version_added: 2.6
  operation:
    choices:
...
from ansible_collections.ansible.amazon.plugins.module_utils.ec2 import ec2_argument_spec, get_ec2_security_group_ids_from_names
