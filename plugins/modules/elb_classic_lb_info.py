...
- This module was called C(elb_classic_lb_facts) before Ansible 2.9. The usage did
  not change.
...
options:
  names:
    ...
    - ec2_elbs
    description:
    - List of ELB names to gather information about. Pass this option to gather information
      about a set of ELBs, otherwise, all ELBs are returned.
requirements:
- botocore
- boto3
