...
DOCUMENTATION = '''author: Deepak Kothandan (@Deepakkothandan) <deepak.kdy@gmail.com>
description:
...
options:
  ...
  kms_key_id:
    description:
    - KMS key id used to encrypt snapshot. If not specified, defaults to EBS Customer
      Master Key (CMK) for that account.
  source_region:
    description:
  ...
  tags:
    description:
    - A hash/dictionary of tags to add to the new Snapshot; '{"key":"value"}' and
      '{"key":"value","key":"value"}'
  wait:
    default: 'no'
    description:
