...
options:
  ...
  message_attributes:
    description:
    - Dictionary of message attributes. These are optional structured data entries
      to be sent along to the endpoint.
  ...
  message_structure:
    ...
    - This must be 'json' to support protocol-specific messages (`http`, `https`,
      `email`, `sms`, `sqs`). It must be 'string' to support message_attributes.
  msg:
    aliases:
    - default
    description:
