...
options:
  ...
  connection_draining_timeout:
    description:
    - Wait a specified timeout allowing connections to drain before terminating an
      instance
    version_added: '1.8'
  ...
  idle_timeout:
    description:
    - ELB connections from clients and to servers are timed out after this amount
      of time
    version_added: '2.0'
  instance_ids:
    description:
  ...
  stickiness:
    description:
    - An associative array of stickiness policy settings. Policy will be applied to
      all listeners ( see example )
    version_added: '2.0'
  subnets:
    description:
    - A list of VPC subnets to use when creating ELB. Zones should be empty if using
      this.
    version_added: '1.7'
  tags:
    description:
  ...
  validate_certs:
    default: 'yes'
    description:
    - When set to C(no), SSL certificates will not be validated for boto versions
      >= 2.6.0.
    type: bool
    version_added: '1.5'
  wait:
    default: 'no'
    description:
    - When specified, Ansible will check the status of the load balancer to ensure
      it has been successfully removed from AWS.
    type: bool
    version_added: '2.1'
  wait_timeout:
    default: 60
