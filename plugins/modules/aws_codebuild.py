...
description:
- Create or delete a CodeBuild projects on AWS, used for building code artifacts from
  source code.
...
options:
    ...
    suboptions:
      location:
        ...
        - Information about the build output artifact location. When choosing type
          S3, set the bucket name here.
        required: false
      name:
        description:
        - Along with path and namespace_type, the pattern that AWS CodeBuild will
          use to name and store the output artifact
        required: false
      namespace_type:
        description:
      ...
      path:
        description:
        - Along with namespace_type and name, the pattern that AWS CodeBuild will
          use to name and store the output artifacts.
  ...
  environment:
    ...
    suboptions:
      compute_type:
        ...
        - 'Available values include: BUILD_GENERAL1_SMALL, BUILD_GENERAL1_MEDIUM,
          BUILD_GENERAL1_LARGE'
        required: true
      environment_variables:
        description:
        - A set of environment variables to make available to builds for the build
          project. List of dictionaries with name and value fields.
      ...
      privileged_mode:
        ...
        - Enables running the Docker daemon inside a Docker container. Set to true
          only if the build project is be used to build Docker images.
        required: false
      type:
        description:
    ...
    suboptions:
      buildspec:
        ...
        - The build spec declaration to use for the builds in this build project.
          Leave empty if part of the code project.
        required: false
      git_clone_depth:
        description:
      ...
      location:
        ...
        - Information about the location of the source code to be built. For type
          CODEPIPELINE location should not be specified.
        required: false
      type:
        description:
        - 'The type of the source. Allows one of these: CODECOMMIT, CODEPIPELINE,
  ...
  timeout_in_minutes:
    default: 60
    description:
    - How long CodeBuild should wait until timing out any build that has not been
      marked as completed.
    required: false
  vpc_config:
    description:
