...
description:
- creates or destroys a data migration services endpoint, that can be used to replicate
  data.
...
options:
  ...
  dynamodbsettings:
    description:
    - Settings in JSON format for the target Amazon DynamoDB endpoint if source or
      target is dynamodb
  ec2_region:
    description:
    - alias for region
  ...
  extraconnectionattributes:
    description:
    - Extra attributes for the database connection, the AWS documentation states "
      For more information about extra connection attributes, see the documentation
      section for your data store."
  kinesissettings:
    description:
  ...
  password:
    description:
    - Password used to connect to the database this attribute can only be written
  ...
  serviceaccessrolearn:
    description:
    - Amazon Resource Name (ARN) for the service access role that you want to use
...
from ansible_collections.ansible.amazon.plugins.module_utils.ec2 import boto3_conn, HAS_BOTO3, \
