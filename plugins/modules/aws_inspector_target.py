...
DOCUMENTATION = '''author: Dennis Conrad (@dennisconrad)
description: Creates, updates, or deletes Amazon Inspector Assessment Targets and
  manages the required Resource Groups.
...
options:
  name:
    description:
    - The user-defined name that identifies the assessment target.  The name must
