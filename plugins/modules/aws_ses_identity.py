...
options:
  bounce_notifications:
    ...
    suboptions:
      include_headers:
        ...
        - If I(topic) is not specified this will have no impact, but the SES setting
          is updated even if there is no topic.
        type: bool
      topic:
        description:
  ...
  identity:
    ...
    - If this contains an '@' then it will be considered an email. Otherwise it will
      be considered a domain.
    required: true
  state:
    choices:
    - present
