...
DOCUMENTATION = '''author: Alan Loi (@loia)
description:
...
options:
  ...
  indexes:
    default: []
    description:
    - list of dictionaries describing indexes to add to the table. global indexes
      can be updated. local indexes don't support updates or have throughput.
    - 'required options: [''name'', ''type'', ''hash_key_name'']'
    - 'valid types: [''all'', ''global_all'', ''global_include'', ''global_keys_only'',
      ''include'', ''keys_only'']'
    - 'other options: [''hash_key_type'', ''range_key_name'', ''range_key_type'',
      ''includes'', ''read_capacity'', ''write_capacity'']'
    version_added: '2.1'
  name:
    description:
    - Name of the table.
