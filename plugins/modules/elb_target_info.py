...
DOCUMENTATION = '''author: Yaakov Kuperman (@yaakov-github)
description:
- This module will search through every target group in a region to find which ones
  have registered a given instance ID or IP.
- This module was called C(elb_target_facts) before Ansible 2.9. The usage did not
  change.
...
from ansible_collections.ansible.amazon.plugins.module_utils.ec2 import (HAS_BOTO3, camel_dict_to_snake_dict,
                                      AWSRetry)
