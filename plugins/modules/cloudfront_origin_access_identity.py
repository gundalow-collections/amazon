...
DOCUMENTATION = '''author: Willem van Ketwich (@wilvk)
description:
...
- boto3 >= 1.0.0
- python >= 2.6
short_description: create, update and delete origin access identities for a cloudfront
  distribution.
version_added: '2.5'
'''
...
from ansible_collections.ansible.amazon.plugins.module_utils.ec2 import get_aws_connection_info, ec2_argument_spec
