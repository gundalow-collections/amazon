...
options:
  ...
  force_set_policy:
    default: false
    description:
    - if no, prevents setting a policy that would prevent you from setting another
  ...
  image_tag_mutability:
    ...
    default: mutable
    description:
    - configure whether repository should be mutable (ie. an already existing tag
...
from ansible_collections.ansible.amazon.plugins.module_utils.ec2 import (HAS_BOTO3, boto3_conn, boto_exception, ec2_argument_spec,
