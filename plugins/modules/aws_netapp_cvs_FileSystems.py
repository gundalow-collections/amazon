...
DOCUMENTATION = '''author: NetApp Ansible Team (@carchi8py) <ng-ansibleteam@netapp.com>
description:
- Create, Update, Delete fileSystem on AWS Cloud Volumes Service.
extends_documentation_fragment:
- netapp.netapp.netapp.awscvs
    ...
    suboptions:
      rules:
        ...
        suboptions:
          allowedClients:
            description:
            - Comma separated list of ip address blocks of the clients to access the
              fileSystem
            - Each address block contains the starting IP address and size for the
              block
            type: str
          cifs:
            description:
