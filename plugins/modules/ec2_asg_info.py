...
options:
  name:
    ...
    - 'Note: This is a regular expression match with implicit ''^'' (beginning of
      string). Append ''$'' for a complete name match.'
    required: false
  tags:
    description:
    - 'A dictionary/hash of tags in the format { tag1_name: ''tag1_value'', tag2_name:
      ''tag2_value'' } to match against the auto scaling group(s) you are searching
      for.
...
from ansible_collections.ansible.amazon.plugins.module_utils.ec2 import (get_aws_connection_info, boto3_conn, ec2_argument_spec,
